...
internal static class ApiResults
{
    ...
    /// stuffing a record into the error's message. Used where a refusal is only
    /// actionable with the blocking record in hand (a support ticket already open
    /// for this pair). Mirrors the pet-parent host's helper of the same shape.
    /// </summary>
