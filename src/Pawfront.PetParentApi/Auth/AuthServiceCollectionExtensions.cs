...
{
    public const string PetParentUserPolicy = "PetParentUser";

    public static IServiceCollection AddPetParentAuthentication(
        ...
        IConfiguration configuration)
    {
        ...
        {
            options.AddPolicy(PetParentUserPolicy, policy =>
            {
