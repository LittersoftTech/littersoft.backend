...
-- [Event].[UpdateEvent] keyed by @PetParentId (THROW 51217 when the event
-- doesn't exist or isn't owned by the parent → API 404 EventNotFound).
--
...
BEGIN
    ...
    -- Payout methods only apply to paid events.
    IF @IsPaid = 0
    BEGIN
